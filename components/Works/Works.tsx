...
const Works = () => {
  return (
    <div className={styles.works}>
      <Title order={1}>How to cut audio</Title>
      <Container size="xl" className={styles.container}>
        <Text>
          This app can be used to trim and/or cut audio tracks, remove an audio fragment. Fade in
          and fade out your music easily to make the audio harmoniously.
        </Text>
        <Text>
          It is fast and easy to use. You can save the audio file in any format (codec parameters
          are configured).
        </Text>
        <Text>
          It works directly in the browser, no need to install any software, and is available for
          mobile devices.
        </Text>
      </Container>

      <Flex align="center" className={styles.heading}>
        ...
        <Title order={1}>Privacy and Security Guaranteed</Title>
      </Flex>
